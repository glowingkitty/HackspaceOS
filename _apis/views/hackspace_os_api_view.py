...
class HackspaceOSapiView(View):
    ...
    def get(self, request, sub_page=None):
        if self.path == 'page' and sub_page:
        ...
        elif self.path == 'save_keyword':
            return HackspaceOS().save_keyword(request)
            ...
            return HackspaceOS().delete_event(request)
        ...
        elif self.path == 'end_meeting':
            return HackspaceOS().end_meeting(request)
